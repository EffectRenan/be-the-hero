...
export default function Detail() {
    ...
    const message = `Hello ${incident.name}, I am entering in contact becase I wish to help "${incident.title}" with ${Intl.NumberFormat('en-US', {style: 'currency', currency: 'USD'}).format(incident.value)}`
    ...
    function sendMail() {
        MailComposer.composeAsync({
            subject: `Hero Incident : ${incident.title}`,
